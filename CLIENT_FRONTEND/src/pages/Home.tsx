...
import { useLazyGetAllCarsQuery } from "../features/cars/carsApiSlice";
...
function Home() {
  ...
  // use the `useLazyGetAllCarsQuery()` to retreive data from the database (makes a GET request) on click
  ...
  return (
    <Container fluid>
      <Row>
        <Col>
          <Form style={{ position: "sticky", top: "50px" }}>
